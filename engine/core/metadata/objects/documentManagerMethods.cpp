...
void CManagerDocumentValue::PrepareNames() const
{
...
CValue CManagerDocumentValue::Method(methodArg_t &aParams)
{
	CValue ret;
	...
	case eSelect:
	{
		class CSelectorDocumentValue : public IDataSelectorValue {
		public:
			CSelectorDocumentValue(CMetaObjectDocumentValue *metaObject) : IDataSelectorValue(metaObject) {}
		};

		return new CSelectorDocumentValue(m_metaObject);
	}
	case eFindByNumber:
	{
