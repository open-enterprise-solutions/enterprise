...
void CManagerCatalogValue::PrepareNames() const
{
...
CValue CManagerCatalogValue::Method(methodArg_t &aParams)
{
	CValue ret;
	...
	case eSelect:
	{
		class CSelectorCatalogValue : public IDataSelectorValue {
		public:
			CSelectorCatalogValue(CMetaObjectCatalogValue *metaObject) : IDataSelectorValue(metaObject) {}
		};

		return new CSelectorCatalogValue(m_metaObject);
	}
