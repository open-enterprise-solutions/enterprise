...
CMethods* CObjectReportValue::GetPMethods() const
{
	CObjectReportValue::PrepareNames();
	return m_methods;
};

void CObjectReportValue::PrepareNames() const
{
...
CValue CObjectReportValue::Method(methodArg_t &aParams)
{
