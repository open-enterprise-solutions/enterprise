...
CMethods* CObjectDocumentValue::GetPMethods() const
{
	CObjectDocumentValue::PrepareNames();
	return m_methods;
};

void CObjectDocumentValue::PrepareNames() const
{
...
CValue CObjectDocumentValue::Method(methodArg_t &aParams)
{
