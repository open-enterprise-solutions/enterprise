...
CObjectDataProcessorValue::CObjectDataProcessorValue(CMetaObjectDataProcessorValue *metaObject) : IDataObjectValue(Guid::newGuid()),
...
bool CObjectDataProcessorValue::InitializeObject()
{
	if (m_metaObject->m_objMode == METAOBJECT_NORMAL) {
...
void CObjectDataProcessorValue::ShowFormValue(const wxString &formName, IValueFrame *owner)
{
...
CValueForm *CObjectDataProcessorValue::GetFormValue(const wxString &formName, IValueFrame *ownerControl)
{
	CValueForm *foundedForm = GetFrame();
