...
class CMetaObjectReportValue : public IMetaObjectValue {
	wxDECLARE_DYNAMIC_CLASS(CMetaObjectReportValue);
...
protected:
	...
	CMetaObjectReportValue(int objMode);

public:

	CMetaObjectReportValue();
	virtual ~CMetaObjectReportValue();
...
protected:
	...
	friend class CObjectReportValue;
};

#define default_meta_id 10 //for reports

class CMetaObjectReportExternalValue : public CMetaObjectReportValue {
	wxDECLARE_DYNAMIC_CLASS(CMetaObjectReportExternalValue);
public:
	CMetaObjectReportExternalValue() : CMetaObjectReportValue(METAOBJECT_EXTERNAL) { m_metaId = default_meta_id; }
	virtual ~CMetaObjectReportExternalValue() {}
...
class CObjectReportValue : public IDataObjectValue {
	virtual void PrepareEmptyObject();
public:
	virtual bool InitializeObject();

	CObjectReportValue(const CObjectReportValue &source);
	CObjectReportValue(CMetaObjectReportValue *metaObject);
	virtual ~CObjectReportValue();
