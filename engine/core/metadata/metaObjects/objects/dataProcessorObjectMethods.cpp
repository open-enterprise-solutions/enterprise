...
CMethods* CObjectDataProcessor::GetPMethods() const
{
	CObjectDataProcessor::PrepareNames();
	return m_methods;
};

void CObjectDataProcessor::PrepareNames() const
{
...
CValue CObjectDataProcessor::Method(methodArg_t &aParams)
{
