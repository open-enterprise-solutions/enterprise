...
wxSTCListBox::wxSTCListBox(wxWindow* parent, ÑListBoxVisualData* v, int ht)
...
wxRect wxSTCListBox::GetDesiredRect() const
{
...
void wxSTCListBox::Append(wxString &s, int type)
{
	AppendHelper(s, type);
...
wxString wxSTCListBox::GetValue(int n) const
{
	return m_labels[n];
}
