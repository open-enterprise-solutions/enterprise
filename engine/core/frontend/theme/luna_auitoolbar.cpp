...
CAuiGenericToolBarArt::CAuiGenericToolBarArt()
{
...
wxAuiToolBarArt* CAuiGenericToolBarArt::Clone()
{
    return static_cast<wxAuiToolBarArt*>(new CAuiGenericToolBarArt);
}

void CAuiGenericToolBarArt::UpdateColoursFromSystem()
{
...
void CAuiGenericToolBarArt::SetFlags(unsigned int flags)
{
    m_flags = flags;
}

void CAuiGenericToolBarArt::SetFont(const wxFont& font)
{
    m_font = font;
}

void CAuiGenericToolBarArt::SetTextOrientation(int orientation)
{
    m_textOrientation = orientation;
}

unsigned int CAuiGenericToolBarArt::GetFlags()
{
    return m_flags;
}

wxFont CAuiGenericToolBarArt::GetFont()
{
    return m_font;
}

int CAuiGenericToolBarArt::GetTextOrientation()
{
    return m_textOrientation;
}

void CAuiGenericToolBarArt::DrawBackground(
    wxDC& dc,
...
void CAuiGenericToolBarArt::DrawPlainBackground(wxDC& dc,
    wxWindow* WXUNUSED(wnd),
    const wxRect& rect)
{
...
void CAuiGenericToolBarArt::DrawLabel(
    wxDC& dc,
    wxWindow* WXUNUSED(wnd),
...
void CAuiGenericToolBarArt::DrawButton(
    wxDC& dc,
    wxWindow* wnd,
    const wxAuiToolBarItem& item,
    const wxRect& rect)
...
void CAuiGenericToolBarArt::DrawDropDownButton(
    wxDC& dc,
    wxWindow* wnd,
    const wxAuiToolBarItem& item,
    const wxRect& rect)
...
void CAuiGenericToolBarArt::DrawControlLabel(
    wxDC& dc,
    wxWindow* WXUNUSED(wnd),
    const wxAuiToolBarItem& item,
    const wxRect& rect)
...
wxSize CAuiGenericToolBarArt::GetLabelSize(
    wxDC& dc,
    wxWindow* WXUNUSED(wnd),
    const wxAuiToolBarItem& item)
{
...
wxSize CAuiGenericToolBarArt::GetToolSize(
    wxDC& dc,
    wxWindow* wnd,
    const wxAuiToolBarItem& item)
{
...
void CAuiGenericToolBarArt::DrawSeparator(
    wxDC& dc,
    wxWindow* wnd,
    const wxRect& _rect)
{
...
void CAuiGenericToolBarArt::DrawGripper(wxDC& dc,
    wxWindow* wnd,
    const wxRect& rect)
{
    int i = 0;
...
void CAuiGenericToolBarArt::DrawOverflowButton(wxDC& dc,
    wxWindow* wnd,
    const wxRect& rect,
    int state)
{
...
int CAuiGenericToolBarArt::GetElementSize(int element_id)
{
    switch (element_id)
    {
...
void CAuiGenericToolBarArt::SetElementSize(int element_id, int size)
{
    switch (element_id)
    {
...
int CAuiGenericToolBarArt::ShowDropDown(wxWindow* wnd,
