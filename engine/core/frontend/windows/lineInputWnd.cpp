...
#include "lineInputWnd.h"

CLineInput::CLineInput(wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style) : wxDialog(parent, id, title, pos, size, style)
{
	...
	// Connect Events
	m_buttonGoTo->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(CLineInput::OnButtonGoToClick), NULL, this);
	m_buttonCancel->Connect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(CLineInput::OnButtonCancelClick), NULL, this);
}

CLineInput::~CLineInput()
{
	// Disconnect Events
	m_buttonGoTo->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(CLineInput::OnButtonGoToClick), NULL, this);
	m_buttonCancel->Disconnect(wxEVT_COMMAND_BUTTON_CLICKED, wxCommandEventHandler(CLineInput::OnButtonCancelClick), NULL, this);
}

void CLineInput::OnButtonGoToClick(wxCommandEvent& event) 
{
	EndModal(wxAtoi(m_lineNumber->GetValue()));
}

void CLineInput::OnButtonCancelClick(wxCommandEvent& event) 
{
