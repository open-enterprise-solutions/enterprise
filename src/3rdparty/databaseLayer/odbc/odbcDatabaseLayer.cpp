...
#if wxUSE_GUI
		SQLRETURN nRet = m_pInterface->GetSQLDriverConnect()((SQLHDBC)m_sqlHDBC, m_parentContext ? (SQLHWND)m_parentContext->GetHandle() : NULL, (SQLTCHAR*)(const char*)connectionCharBuffer,
