...
bool FirebirdPreparedStatement::AddPreparedStatement(const wxString& strSQL)
{
...
void FirebirdPreparedStatement::SetParamNumber(int nPosition, const number_t& dblValue)
{
	int nIndex = FindStatementAndAdjustPositionIndex(&nPosition);
	if (nIndex > -1)
		m_Statements[nIndex]->SetParam(nPosition, dblValue);
