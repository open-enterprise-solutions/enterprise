...
public:
	...
	wxString GetDescription() const override
	{
		return ibMcpText("Ask the RUNNING APPLICATION for a picture of its window - the screen the "
			...
			"It is NOT the way to check a value - debug_sandbox says WHY a number is what it is, "
			"which a picture never can. And it does not need the runtime stopped: a window draws "
			"itself while the application runs.\n\n"
