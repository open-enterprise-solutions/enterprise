...
// (The QUERY-layer varieties moved to query/queryException.h — they are raised on L3-L5 and had no
// business living in the database tier's header. See that file for the division of labour.)
