...
//	Description : chart of calculation types object
////////////////////////////////////////////////////////////////////////////
...
//*********************************************************************************************
//*                          ObjectChartOfCalculationTypesValue                             *
//*********************************************************************************************

ibValueRecordDataObjectChartOfCalculationTypes::ibValueRecordDataObjectChartOfCalculationTypes(const ibValueMetaObjectChartOfCalculationTypes* metaObject, const ibGuid& objGuid, ibObjectMode objMode) :
	ibValueRecordDataObjectHierarchyRef(metaObject, objGuid, objMode)
{
	m_members.Bind(this, &ibValueRecordDataObjectChartOfCalculationTypes::FillMethods);
}

ibValueRecordDataObjectChartOfCalculationTypes::ibValueRecordDataObjectChartOfCalculationTypes(const ibValueRecordDataObjectChartOfCalculationTypes& source) :
...
const ibSourceExplorer* ibValueRecordDataObjectChartOfCalculationTypes::GetSourceExplorer() const
{
	...
	if (m_metaObject->ConvertToValue(metaRef)) {
		m_sourceExplorer.AppendColumn(metaRef->GetDataCode()->GetQueryColumn(), /*enabled*/ false, /*visible*/ true);
		m_sourceExplorer.AppendColumn(metaRef->GetDataDescription()->GetQueryColumn(), /*enabled*/ true, /*visible*/ true);
		m_sourceExplorer.AppendColumn(metaRef->GetDataParent()->GetQueryColumn(), /*enabled*/ true, /*visible*/ true);
	}
		...
		if (m_objMode == ibObjectMode::OBJECT_ITEM) {
			if (attrUse == ibItemMode::ibItemMode_Item
				...
				if (!m_metaObject->IsDataReference(object->GetMetaID())) {
					m_sourceExplorer.AppendColumn(object->GetQueryColumn(), /*enabled*/ true, /*visible*/ true);
				}
			}
		}
		else {
		...
		if (m_objMode == ibObjectMode::OBJECT_ITEM) {
			if (tableUse == ibItemMode::ibItemMode_Item
				...
				if (object != nullptr && !object->IsDeleted()) {
					...
					for (ibValueMetaObjectAttributeBase* tblCol : object->GetGenericAttributeArrayObject()) tblNode.AppendColumn(tblCol->GetQueryColumn(), /*enabled*/ true, /*visible*/ true);
				}
			}
		}
		else {
...
//***********************************************************************************************
//*                        ChartOfCalculationTypes events                                    *
//***********************************************************************************************
...
void ibValueRecordDataObjectChartOfCalculationTypes::FillMethods(ibMemberTable& helper) const
{
...
bool ibValueRecordDataObjectChartOfCalculationTypes::SetPropVal(const long lPropNum, const ibValue& varPropVal)
{
...
bool ibValueRecordDataObjectChartOfCalculationTypes::GetPropVal(const long lPropNum, ibValue& pvarPropVal)
{
	const long lPropAlias = m_members.GetPropAlias(lPropNum);
	if (lPropAlias == eProcUnit) {
		if (m_procUnit != nullptr) {
