...
//	Description : chart of calculation types metaData - menu
////////////////////////////////////////////////////////////////////////////

#include "chartOfCalculationTypes.h"
#include "backend/metaData.h"

bool ibValueMetaObjectChartOfCalculationTypes::CollectContextMenu(std::vector<ibMetaMenuItem>& items)
{
...
void ibValueMetaObjectChartOfCalculationTypes::ProcessCommand(unsigned int id)
{
