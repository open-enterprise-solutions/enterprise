...
#include "backend/databaseLayer/databaseResultSet.h"      // ibDatabaseResultSet — GetBinaryData
#include "backend/databaseLayer/preparedStatement.h"       // ibPreparedStatement — SetBinaryData binds
