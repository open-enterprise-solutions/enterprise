...
#pragma endregion
	...
	// ⭐ THE SAME QUESTION WITHOUT AN AREA: everything the section shows, once each — its Default, Create,
	// Report and Service items in that order, an object listed the first time it appears.
	//
