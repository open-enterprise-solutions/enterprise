...
class ibPGOwnerProperty : public wxPGProperty {
public:
	...
	ibPGOwnerProperty(const ibPropertyObject* property = nullptr, const wxString& label = wxPG_LABEL,
...
private:
	WX_PG_DECLARE_PROPERTY_CLASS(ibPGOwnerProperty);
};
