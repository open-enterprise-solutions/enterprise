...
// Purpose:     ibThemeRenderer class declaration
...
// ----------------------------------------------------------------------------
// ibThemeRenderer: implements as much of ibRenderer API as possible generically
// ----------------------------------------------------------------------------

class ibThemeRenderer : public ibRenderer
{
public:
    ...
    ibThemeRenderer(const ibColourScheme *scheme);
...
protected:
    ...
    const ibColourScheme * const m_scheme;

    wxDECLARE_NO_COPY_CLASS(ibThemeRenderer);
};
