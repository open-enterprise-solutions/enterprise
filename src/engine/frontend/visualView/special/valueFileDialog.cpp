...
m_dirDialog(new wxDirDialog(CDocMDIFrame::GetFrame())), m_fileDialog(new wxFileDialog(CDocMDIFrame::GetFrame()))
{
}
...
VALUE_TYPE_REGISTER(CValueFileDialog, "fileDialog", TEXT2CLSID("VL_FDIA"));
//add new enumeration
ENUM_TYPE_REGISTER(CValueEnumFileDialogMode, "fileDialogMode", TEXT2CLSID("EN_FDIM"));