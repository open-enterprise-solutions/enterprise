...
wxAuiLunaTabArt::wxAuiLunaTabArt()
{
...
{
	return new wxAuiLunaTabArt(*this);
}

void wxAuiLunaTabArt::SetFlags(unsigned int flags)
{
	m_flags = flags;
}

void wxAuiLunaTabArt::SetSizingInfo(const wxSize& tab_ctrl_size,
	size_t tab_count,
	wxWindow* wnd)
{
	if (!wnd)
...
void wxAuiLunaTabArt::DrawBorder(wxDC& dc, wxWindow* wnd, const wxRect& rect)
{
...
void wxAuiLunaTabArt::DrawBackground(wxDC& dc,
...
void wxAuiLunaTabArt::DrawTab(wxDC& dc,
	wxWindow* wnd,
...
int wxAuiLunaTabArt::GetIndentSize()
{
	return wxWindow::FromDIP(5, nullptr);
}

int wxAuiLunaTabArt::GetBorderWidth(wxWindow* wnd)
{
...
int wxAuiLunaTabArt::GetAdditionalBorderSpace(wxWindow* WXUNUSED(wnd))
{
	return 0;
}
...
void wxAuiLunaTabArt::DrawButton(wxDC& dc,
	wxWindow* wnd,
	const wxRect& in_rect,
	int bitmap_id,
	int button_state,
...
int wxAuiLunaTabArt::ShowDropDown(wxWindow* wnd,
...
int wxAuiLunaTabArt::GetBestTabCtrlSize(wxWindow* wnd,
	const wxAuiNotebookPageArray& pages,
...
void wxAuiLunaTabArt::SetNormalFont(const wxFont& font)
{
	m_normalFont = font;
}

void wxAuiLunaTabArt::SetSelectedFont(const wxFont& font)
{
	m_selectedFont = font;
}

void wxAuiLunaTabArt::SetMeasuringFont(const wxFont& font)
{
	m_measuringFont = font;
}

void wxAuiLunaTabArt::SetColour(const wxColour& colour)
{
	m_baseColour = colour;
...
void wxAuiLunaTabArt::SetActiveColour(const wxColour& colour)
{
