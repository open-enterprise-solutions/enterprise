...
// wxAuiLunaDockArt is an art provider class which does all of the drawing for
...
wxAuiLunaDockArt::wxAuiLunaDockArt() : wxAuiDockArt()
{
...
void wxAuiLunaDockArt::InitBitmaps()
{
...
void wxAuiLunaDockArt::UpdateColoursFromSystem()
{
	...
	wxColor darker1Colour = baseColour.ChangeLightness(97);
	...
	m_borderPen.SetCap(wxCAP_PROJECTING);
	m_borderPen.SetJoin(wxJOIN_MITER);

	m_sashPen = wxPen(darker2Colour, 1, wxPENSTYLE_DOT);
	m_sashPen.SetCap(wxCAP_PROJECTING);
	m_sashPen.SetJoin(wxJOIN_MITER);
	...
	m_gripperPen3 = wxPen(darker1Colour, pen_width);

	InitBitmaps();
}

int wxAuiLunaDockArt::GetMetric(int id)
{
	switch (id)
	{
...
void wxAuiLunaDockArt::SetMetric(int id, int new_val)
{
	switch (id)
	{
...
wxColour wxAuiLunaDockArt::GetColour(int id)
{
	switch (id)
	{
...
void wxAuiLunaDockArt::SetColour(int id, const wxColor& colour)
{
	switch (id)
	{
...
void wxAuiLunaDockArt::SetFont(int id, const wxFont& font)
{
	if (id == wxAUI_DOCKART_CAPTION_FONT)
		m_captionFont = font;
}

wxFont wxAuiLunaDockArt::GetFont(int id)
{
	if (id == wxAUI_DOCKART_CAPTION_FONT)
...
void wxAuiLunaDockArt::DrawBackground(wxDC& dc, wxWindow *WXUNUSED(window), int, const wxRect& rect)
{
	dc.SetPen(*wxTRANSPARENT_PEN);
	dc.SetBrush(THEME_COLOUR_BACKGROUND);
	dc.DrawRectangle(rect.x, rect.y, rect.width, rect.height);
}

void wxAuiLunaDockArt::DrawBorder(wxDC& dc, wxWindow* window, const wxRect& _rect,
	wxAuiPaneInfo& pane)
{
...
void wxAuiLunaDockArt::DrawCaptionBackground(wxDC& dc, const wxRect& rect, bool active)
{
...
void wxAuiLunaDockArt::DrawCaption(wxDC& dc,
	wxWindow* window,
	const wxString& text,
	const wxRect& rect,
	wxAuiPaneInfo& pane)
...
void wxAuiLunaDockArt::DrawIcon(wxDC& dc, const wxRect& rect, wxAuiPaneInfo& pane)
{
...
void
wxAuiLunaDockArt::DrawIcon(wxDC& dc, wxWindow *window, const wxRect& rect, wxAuiPaneInfo& pane)
{
	if (!window)
	{
...
void wxAuiLunaDockArt::DrawGripper(wxDC& dc,
	wxWindow* window,
	const wxRect& rect,
	wxAuiPaneInfo& pane)
{
...
void wxAuiLunaDockArt::DrawPaneButton(wxDC& dc,
	wxWindow* window,
	int button,
	int button_state,
	const wxRect& _rect,
