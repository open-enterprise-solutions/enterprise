...
wxBEGIN_EVENT_TABLE(CDialogAbout, wxDialog)
EVT_BUTTON(ID_OK, CDialogAbout::OnButtonEvent)
wxEND_EVENT_TABLE()

#include "backend/backend_core.h"

CDialogAbout::CDialogAbout(wxWindow *parent, int id) : wxDialog(parent, id, _("About..."))
{
...
void CDialogAbout::OnButtonEvent(wxCommandEvent &)
{
	Close();
}
