...
class CGridPropertyObject : public IPropertyObject {
	CGrid* m_ownerGrid;
private:
	...
	Property* m_propertyAlignHorz = IPropertyObject::CreateProperty(m_categoryAlignment, { "align_horz", "align horz" }, &CGridPropertyObject::GetAlignment);
	Property* m_propertyAlignVert = IPropertyObject::CreateProperty(m_categoryAlignment, { "align_vert", "align vert" }, &CGridPropertyObject::GetAlignment);
	Property* m_propertyOrient = IPropertyObject::CreateProperty(m_categoryAlignment, "orient_text", &CGridPropertyObject::GetOrient);
	...
	Property* m_propertyLeftBorder = IPropertyObject::CreateProperty(m_categoryBorder, { "left_border", "left border" }, &CGridPropertyObject::GetBorder, wxPENSTYLE_TRANSPARENT);
	Property* m_propertyRightBorder = IPropertyObject::CreateProperty(m_categoryBorder, { "right_border", "right border" }, &CGridPropertyObject::GetBorder, wxPENSTYLE_TRANSPARENT);
	Property* m_propertyTopBorder = IPropertyObject::CreateProperty(m_categoryBorder, { "top_border", "top border" }, &CGridPropertyObject::GetBorder, wxPENSTYLE_TRANSPARENT);
	Property* m_propertyBottomBorder = IPropertyObject::CreateProperty(m_categoryBorder, { "bottom_border", "bottom border" }, &CGridPropertyObject::GetBorder, wxPENSTYLE_TRANSPARENT);
...
public:
	...
	CGridPropertyObject(CGrid* ownerGrid);
	virtual ~CGridPropertyObject();
