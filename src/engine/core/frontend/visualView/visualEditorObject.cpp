...
{
public:
	BaseVisualCmd(CVisualEditorNotebook::CVisualEditorCtrl* visualData = NULL) :
...
protected:
	CVisualEditorNotebook::CVisualEditorCtrl* m_visualData;
};
...
public:
	...
	ExpandObjectCmd(CVisualEditorNotebook::CVisualEditorCtrl* data, IValueFrame* object, bool expand);
...
public:
	...
	InsertObjectCmd(CVisualEditorNotebook::CVisualEditorCtrl* data, IValueFrame* object, IValueFrame* parent, int pos = -1, bool firstCreated = true);
...
public:
	...
	RemoveObjectCmd(CVisualEditorNotebook::CVisualEditorCtrl* data, IValueFrame* object);
	~RemoveObjectCmd();
...
public:
	...
	ModifyPropertyCmd(CVisualEditorNotebook::CVisualEditorCtrl* data, Property* prop, const wxVariant& newValue);
...
public:
	ModifyEventHandlerCmd(CVisualEditorNotebook::CVisualEditorCtrl* data, Event* event, const wxString& newValue);
...
public:
	ShiftChildCmd(CVisualEditorNotebook::CVisualEditorCtrl* data, IValueFrame* object, int pos);
...
public:
	...
	CutObjectCmd(CVisualEditorNotebook::CVisualEditorCtrl* data, IValueFrame* object, bool force);
	~CutObjectCmd();
...
ExpandObjectCmd::ExpandObjectCmd(CVisualEditorNotebook::CVisualEditorCtrl* data, IValueFrame* object, bool expand) : BaseVisualCmd(data),
...
InsertObjectCmd::InsertObjectCmd(CVisualEditorNotebook::CVisualEditorCtrl* data, IValueFrame* object, IValueFrame* parent, int pos, bool firstCreated) : BaseVisualCmd(data),
...
{
	if (m_visualData->m_document != NULL)
	...
	CVisualEditorNotebook::CVisualEditorCtrl::CVisualEditorHost* visulEditor =
...
void InsertObjectCmd::DoRestore()
{
	...
	CVisualEditorNotebook::CVisualEditorCtrl::CVisualEditorHost* m_visualEditor =
		m_visualData->GetVisualEditor();
...
RemoveObjectCmd::RemoveObjectCmd(CVisualEditorNotebook::CVisualEditorCtrl* data, IValueFrame* object) : BaseVisualCmd(data)
{
	m_object = object;
...
{
	//remove control in visual editor
	CVisualEditorNotebook::CVisualEditorCtrl::CVisualEditorHost* visulEditor = m_visualData->GetVisualEditor();
...
ModifyPropertyCmd::ModifyPropertyCmd(CVisualEditorNotebook::CVisualEditorCtrl* data, Property* prop, const wxVariant& newValue) : BaseVisualCmd(data),
...
ModifyEventHandlerCmd::ModifyEventHandlerCmd(CVisualEditorNotebook::CVisualEditorCtrl* data, Event* event, const wxString& newValue) : BaseVisualCmd(data),
m_event(event), m_newValue(newValue)
{
...
ShiftChildCmd::ShiftChildCmd(CVisualEditorNotebook::CVisualEditorCtrl* data, IValueFrame* object, int pos) : BaseVisualCmd(data)
{
	m_object = object;
...
CutObjectCmd::CutObjectCmd(CVisualEditorNotebook::CVisualEditorCtrl* data, IValueFrame* object, bool force) : BaseVisualCmd(data), m_needEvent(!force)
{
	m_object = object;
	m_parent = object->GetParent();
	m_oldPos = m_parent->GetChildPosition(object);
...
IValueFrame* CVisualEditorNotebook::CVisualEditorCtrl::CreateObject(const wxString& name)
{
...
void CVisualEditorNotebook::CVisualEditorCtrl::InsertObject(IValueFrame* obj, IValueFrame* parent)
{
	Execute(new InsertObjectCmd(this, obj, parent));
	NotifyObjectCreated(obj);
}

void CVisualEditorNotebook::CVisualEditorCtrl::CopyObject(IValueFrame* obj)
{
	m_copyOnPaste = true;
...
bool CVisualEditorNotebook::CVisualEditorCtrl::PasteObject(IValueFrame* dstObject, IValueFrame* objToPaste)
{
	wxASSERT(m_valueForm);
...
IValueFrame* CVisualEditorNotebook::CVisualEditorCtrl::SearchSizerInto(IValueFrame* obj)
{
...
void CVisualEditorNotebook::CVisualEditorCtrl::ExpandObject(IValueFrame* obj, bool expand)
{
...
void CVisualEditorNotebook::CVisualEditorCtrl::RemoveObject(IValueFrame* obj)
{
	DoRemoveObject(obj, false);
}

void CVisualEditorNotebook::CVisualEditorCtrl::CutObject(IValueFrame* obj, bool force)
{
	DoRemoveObject(obj, true, force);
}

bool CVisualEditorNotebook::CVisualEditorCtrl::SelectObject(IValueFrame* obj, bool force, bool notify)
{
...
void CVisualEditorNotebook::CVisualEditorCtrl::MovePosition(IValueFrame* obj, unsigned int toPos)
{
...
void CVisualEditorNotebook::CVisualEditorCtrl::MovePosition(IValueFrame* obj, bool right, unsigned int num)
{
...
void CVisualEditorNotebook::CVisualEditorCtrl::ModifyProperty(Property* prop, const wxVariant& newValue)
{
...
void CVisualEditorNotebook::CVisualEditorCtrl::ModifyEvent(Event* evt, const wxString& newValue)
{
	IPropertyObject* object = evt->GetObject();
	if (newValue != evt->GetValue()) {
		Execute(new ModifyEventHandlerCmd(this, evt, newValue));
...
void CVisualEditorNotebook::CVisualEditorCtrl::PropagateExpansion(IValueFrame* obj, bool expand, bool up)
{
	if (obj != NULL) {
		if (up) {
...
void CVisualEditorNotebook::CVisualEditorCtrl::DoRemoveObject(IValueFrame* obj, bool cutObject, bool force)
{
	// Note:
...
void CVisualEditorNotebook::CVisualEditorCtrl::DetermineObjectToSelect(IValueFrame* parent, unsigned int pos)
{
...
void CVisualEditorNotebook::CVisualEditorCtrl::Undo()
{
	m_cmdProc->Undo();
...
void CVisualEditorNotebook::CVisualEditorCtrl::Redo()
{
	m_cmdProc->Redo();
	m_document->Modify(!m_cmdProc->IsAtSavePoint());
	NotifyProjectRefresh();
...
bool CVisualEditorNotebook::CVisualEditorCtrl::CanPasteObject() const
{
...
bool CVisualEditorNotebook::CVisualEditorCtrl::CanCopyObject() const
{
	IValueFrame* obj = GetSelectedObject();
...
bool CVisualEditorNotebook::CVisualEditorCtrl::IsModified() const {
	return m_document->IsModified();
}

int CVisualEditorNotebook::CVisualEditorCtrl::CalcPositionOfInsertion(IValueFrame* selected, IValueFrame* parent)
{
	int pos = wxNOT_FOUND;
	if (parent && selected) {
...
void CVisualEditorNotebook::CVisualEditorCtrl::ToggleBorderFlag(IValueFrame* obj, int border)
{
	if (!obj)
		return;
	IValueFrame* parent = obj->GetParent();
...
void CVisualEditorNotebook::CVisualEditorCtrl::CreateBoxSizerWithObject(IValueFrame* obj)
{
	IValueFrame* parent = obj->GetParent();
	if (!parent)
		return;
