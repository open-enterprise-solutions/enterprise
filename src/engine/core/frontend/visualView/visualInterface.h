...
class CORE_API IVisualHost : public wxScrolledWindow {
...
public:
	...
	IVisualHost(wxWindow* parent,
		...
		long style = wxScrolledWindowStyle) : wxScrolledWindow(parent, id, pos, size, style | wxBORDER_SUNKEN), m_mainBoxSizer(NULL)
	{
