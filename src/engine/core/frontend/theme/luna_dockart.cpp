...
// -- CLunaDockArt class implementation --
...
#else
	m_sashSize = wxWindow::FromDIP(3, NULL);
#endif
...
void CLunaDockArt::UpdateColoursFromSystem()
{
#if defined( __WXMAC__ ) && wxOSX_USE_COCOA_OR_CARBON
...
int CLunaDockArt::GetMetric(int id)
{
	switch (id)
	{
...
void CLunaDockArt::SetMetric(int id, int new_val)
{
	switch (id)
	{
...
wxColour CLunaDockArt::GetColour(int id)
{
	switch (id)
	{
...
void CLunaDockArt::SetColour(int id, const wxColor& colour)
{
	switch (id)
	{
...
void CLunaDockArt::SetFont(int id, const wxFont& font)
{
	if (id == wxAUI_DOCKART_CAPTION_FONT)
		m_captionFont = font;
}

wxFont CLunaDockArt::GetFont(int id)
{
	if (id == wxAUI_DOCKART_CAPTION_FONT)
...
void CLunaDockArt::DrawSash(wxDC& dc, wxWindow *window, int orientation, const wxRect& rect)
{
#if defined( __WXMAC__ ) && wxOSX_USE_COCOA_OR_CARBON
	wxUnusedVar(window);
...
void CLunaDockArt::DrawBackground(wxDC& dc, wxWindow *WXUNUSED(window), int, const wxRect& rect)
{
...
void CLunaDockArt::DrawBorder(wxDC& dc, wxWindow* window, const wxRect& _rect,
	wxAuiPaneInfo& pane)
{
...
void CLunaDockArt::DrawCaptionBackground(wxDC& dc, const wxRect& rect, bool active)
{
...
void CLunaDockArt::DrawCaption(wxDC& dc,
	wxWindow* window,
	const wxString& text,
	const wxRect& rect,
	wxAuiPaneInfo& pane)
...
void CLunaDockArt::DrawIcon(wxDC& dc, const wxRect& rect, wxAuiPaneInfo& pane)
{
...
void CLunaDockArt::DrawGripper(wxDC& dc,
	wxWindow* window,
	const wxRect& rect,
	wxAuiPaneInfo& pane)
{
...
void CLunaDockArt::DrawPaneButton(wxDC& dc,
	wxWindow* window,
	int button,
	int button_state,
	const wxRect& _rect,
