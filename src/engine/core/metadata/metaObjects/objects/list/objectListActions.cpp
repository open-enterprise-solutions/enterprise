...
CListDataObjectRef::actionData_t CListDataObjectGroupRef::GetActions(const form_identifier_t& formType)
{
	actionData_t actions(this);
...
void CListDataObjectGroupRef::ExecuteAction(const action_identifier_t& action, CValueForm* srcForm)
{
	switch (action)
	{
	case eChooseValue:
