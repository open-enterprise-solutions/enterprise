...
//*                              Override attribute                          *
//****************************************************************************
void CEnumerationManager::SetAttribute(attributeArg_t &aParams, CValue &cValue) {}       //установка атрибута

#include "compiler/methods.h"

CValue CEnumerationManager::GetAttribute(attributeArg_t &aParams)                     //значение атрибута
{
