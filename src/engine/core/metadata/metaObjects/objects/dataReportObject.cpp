...
CObjectReport::CObjectReport(const CObjectReport &source) : IRecordDataObject(source),
...
CObjectReport::CObjectReport(CMetaObjectReport *metaObject) : IRecordDataObject(Guid::newGuid()),
...
bool CObjectReport::InitializeObject()
{
	if (m_metaObject->m_objMode == METAOBJECT_NORMAL) {
