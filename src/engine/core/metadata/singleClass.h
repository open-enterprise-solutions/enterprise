...
#include "core/compiler/singleObject.h"
...
public:
	...
	inline bool ConvertToMetaValue(metaType*& refValue) {
		IMetaObject* metaObject = GetMetaObject();
		return metaObject ? metaObject->ConvertToValue(refValue) : false;
	}
...
#define clsid_start 1000000000000000000ul
...
public:
	...
	virtual wxString GetClassName() const {
		return m_metaValue->GetClassName() + wxT("Ref.") + m_metaValue->GetName();
	}
	virtual CLASS_ID GetTypeClass() const {
		return ((clsid_start + m_metaValue->GetMetaID() * def_offset) + 1);
	}
	...
	virtual eMetaObjectType GetMetaType() const {
		return eMetaObjectType::enReference;
	}
};
...
public:
	...
	virtual wxString GetClassName() const {
		return m_metaValue->GetClassName() + wxT("List.") + m_metaValue->GetName();
	}
	virtual CLASS_ID GetTypeClass() const {
		return ((clsid_start + m_metaValue->GetMetaID() * def_offset) + 2);
	}
	virtual wxClassInfo* GetClassInfo() const;
...
public:
	...
	virtual wxString GetClassName() const {
		return m_metaValue->GetClassName() + wxT("Object.") + m_metaValue->GetName();
	}
	virtual CLASS_ID GetTypeClass() const {
		return ((clsid_start + m_metaValue->GetMetaID() * def_offset) + 3);
	}
	...
	virtual eMetaObjectType GetMetaType() const {
		return eMetaObjectType::enObject;
	}
};
...
public:
	...
	virtual wxString GetClassName() const {
		return ((IMetaObject*)m_metaValue)->GetClassName() + wxT("Object.") + ((IMetaObject*)m_metaValue)->GetName();
	}

	virtual CLASS_ID GetTypeClass() const {
		return ((clsid_start + ((IMetaObject*)m_metaValue)->GetMetaID() * def_offset) + 3);
	}
	...
	virtual IMetaObject* GetMetaObject() const {
		return (IMetaObject*)m_metaValue;
	}
...
public:
	...
	virtual wxString GetClassName() const {
		return m_metaValue->GetClassName() + wxT("Manager.") + m_metaValue->GetName();
	}

	virtual CLASS_ID GetTypeClass() const {
		return ((clsid_start + m_metaValue->GetMetaID() * def_offset) + 4);
	}
	...
	virtual eMetaObjectType GetMetaType() const {
		return eMetaObjectType::enManager;
	}
};
...
public:
	...
	virtual wxString GetClassName() const {
		return m_metaValue->GetClassName() + wxT("Selection.") + m_metaValue->GetName();
	}

	virtual CLASS_ID GetTypeClass() const {
		return ((clsid_start + m_metaValue->GetMetaID() * def_offset) + 5);
	}
	...
	virtual eMetaObjectType GetMetaType() const {
		return eMetaObjectType::enSelection;
	}
};
...
public:
	...
	virtual wxString GetClassName() const {
		return m_metaValue->GetClassName() + wxT("TabularSection.") + m_metaValue->GetName() + wxT(".") + m_metaTable->GetName();
	}

	virtual CLASS_ID GetTypeClass() const {
		return ((clsid_start + (m_metaValue->GetMetaID() + m_metaTable->GetMetaID()) * def_offset) + 6);
	}
	...
	virtual eMetaObjectType GetMetaType() const {
		return eMetaObjectType::enTabularSection;
	}
};
...
public:
	...
	virtual wxString GetClassName() const {
		return m_metaValue->GetClassName() + wxT("RecordKey.") + m_metaValue->GetName();
	}

	virtual CLASS_ID GetTypeClass() const {
		return ((clsid_start + m_metaValue->GetMetaID() * def_offset) + 7);
	}
...
public:
	...
	virtual wxString GetClassName() const {
		return m_metaValue->GetClassName() + wxT("RecordManager.") + m_metaValue->GetName();
	}

	virtual CLASS_ID GetTypeClass() const {
		return ((clsid_start + m_metaValue->GetMetaID() * def_offset) + 8);
	}
	...
	virtual eMetaObjectType GetMetaType() const {
		return eMetaObjectType::enRecordManager;
	}
};
...
public:
	...
	virtual wxString GetClassName() const {
		return m_metaValue->GetClassName() + wxT("RecordSet.") + m_metaValue->GetName();
	}

	virtual CLASS_ID GetTypeClass() const {
		return ((clsid_start + m_metaValue->GetMetaID() * def_offset) + 9);
	}
	...
	virtual eMetaObjectType GetMetaType() const {
		return eMetaObjectType::enRecordSet;
	}
};
